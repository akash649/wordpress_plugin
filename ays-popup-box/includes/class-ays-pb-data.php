                ...
                $content[] = '<div id="ays-pb-dicount-month" class="ays_pb_dicount_month">';
                    ...
                    $content[] = '<div class="ays-pb-dicount-wrap-box ays-pb-dicount-wrap-text-box">';
                        $content[] = '<div>';
                            ...
                            // $content[] = '</span>';
                            $content[] = '<span class="ays-pb-new-mega-bundle-title">';
                            $content[] = __( "Limited Time <span style='color:#ffffff;'>20%</span> SALE on <span><a href='https://ays-pro.com/wordpress/popup-box' target='_blank' style='color:#ffffff; text-decoration: underline;'>Popup Box</a></span>", AYS_PB_NAME );
                        $content[] = '</span>';
                            $content[] = '</br>';
                    ...
                    $content[] = '<div class="ays-pb-dicount-wrap-box ays-pb-dicount-wrap-button-box">';
                        $content[] = '<a href="https://ays-pro.com/wordpress/popup-box" class="button button-primary ays-button" id="ays-button-top-buy-now" target="_blank">' . __( 'Buy Now', AYS_PB_NAME ) . '</a>';
